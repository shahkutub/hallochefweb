...
class ProductRrestaurantWidget extends StatelessWidget {
  ...
  ProductRrestaurantWidget({@required this.product, @required this.isRestaurant, @required this.restaurant, @required this.index,
