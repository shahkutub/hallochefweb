...
import 'package:efood_multivendor/view/base/product_restaurant_widget.dart';
...
class ProductViewBig extends StatelessWidget {
  ...
  ProductViewBig({@required this.restaurants, @required this.products, @required this.isRestaurant, this.isScrollable = false,
    ...
    return Column(children: [
      ...
      !_isNull ? _length > 0 ? GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio: ResponsiveHelper.isDesktop(context) ? 2 : showTheme1Restaurant ? .9 : 1.6,
        ...
        itemBuilder: (context, index) {
          ...
          // );
          return showTheme1Restaurant ? RestaurantWidget(restaurant: restaurants[index], index: index, inStore: inRestaurantPage) :  ProductRrestaurantWidget(
            isRestaurant: isRestaurant, product: isRestaurant ? null : products[index],
            restaurant: isRestaurant ? restaurants[index] : null, index: index, length: _length, isCampaign: isCampaign,
            inRestaurant: inRestaurantPage,
          );
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisSpacing: Dimensions.PADDING_SIZE_LARGE,
          mainAxisSpacing: ResponsiveHelper.isDesktop(context) ? Dimensions.PADDING_SIZE_LARGE : 0.01,
          childAspectRatio: ResponsiveHelper.isDesktop(context) ? 2 : showTheme1Restaurant ? .9 : 2,
