...
class PickUpHomeScreen extends StatefulWidget {
  ...
  @override
  State<PickUpHomeScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<PickUpHomeScreen> {
  ...
  void initState() {
    ...
    PickUpHomeScreen.loadData(false);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //             ],
      //           ),
      //           Text('Pick-Up',style: robotoRegular.copyWith(
      //             color: Colors.white, fontSize: Dimensions.fontSizeSmall,
      //           ),)
      //         ],
      //       ),
