...
class OrderTrackingScreenWeb extends StatefulWidget {
  final String orderID;
  OrderTrackingScreenWeb({@required this.orderID});

  @override
  _OrderTrackingScreenState createState() => _OrderTrackingScreenState();
}

class _OrderTrackingScreenState extends State<OrderTrackingScreenWeb> with WidgetsBindingObserver {
