...
class RunningOrderViewWidgetNewDashboard extends StatefulWidget {

  @override
  RunningOrderViewWidgetNew createState() => RunningOrderViewWidgetNew();
}


class RunningOrderViewWidgetNew extends State<RunningOrderViewWidgetNewDashboard> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<OrderController>(builder: (orderController) {
      ...
      String _orderStatus = '';
      //orderController.runningOrderList != null ? orderController.runningOrderList[orderController.runningOrderIndex].orderStatus : '';
      ...
      {
        print('hi periodic!');
        _orderStatus = orderController.runningOrderList != null ? orderController.runningOrderList[orderController.runningOrderIndex].orderStatus : '';
        print('out for delivery: $_orderStatus');
            ...
            child:  Column(children: [
              ...
              Row(
                children: [
                  ...
                  _orderStatus == AppConstants.PENDING ? Flexible(child:  LinearProgressIndicator(
                    minHeight: 5,
                    backgroundColor: Colors.grey,
                    valueColor: new AlwaysStoppedAnimation<Color>(Colors.red),
                  ),flex: 1,) : Flexible(child:  LinearProgressIndicator(
                    minHeight: 5,
                    value: 0,
                    backgroundColor: Colors.grey,
                    valueColor: new AlwaysStoppedAnimation<Color>(Colors.red),
                  ...
                  SizedBox(width: 10,),
                  _orderStatus == AppConstants.ACCEPTED ? Flexible(child:  LinearProgressIndicator(
                    minHeight: 5,
                    backgroundColor: Colors.grey,
                    valueColor: new AlwaysStoppedAnimation<Color>(Colors.red),
                  ),flex: 1,) : Flexible(child:  LinearProgressIndicator(
                  ...
                  _orderStatus == AppConstants.PROCESSING ? Flexible(child:  LinearProgressIndicator(
                    minHeight: 5,
                    backgroundColor: Colors.grey,
                    valueColor: new AlwaysStoppedAnimation<Color>(Colors.red),
                  ),flex: 1,) : Flexible(child:  LinearProgressIndicator(
                  ...
                  _orderStatus == AppConstants.CONFIRMED ? Flexible(child:  LinearProgressIndicator(
                    minHeight: 5,
                    backgroundColor: Colors.grey,
                    valueColor: new AlwaysStoppedAnimation<Color>(Colors.red),
                  ),flex: 1,) : Flexible(child:  LinearProgressIndicator(
